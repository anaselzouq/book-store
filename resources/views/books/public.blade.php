...
<body>
    ...
    <section class="text-center mb-5" style="margin-top: 6rem">
        ...
        <p class="mt-3">
            مساحتك الخاصة للقصص المهمة. انغمس في مجموعة مختارة من <br> الروايات العربية والمترجمة، ودع كل صفحة تُحرك
            مشاعرك.
        </p>
    </section>
        ...
        <div class="container">
            ...
            <div class="row justify-content-center">
                <div class="col-md-8">
                    <form method="POST" action="{{ route('contact.send') }}">
                        ...
                        <input type="email" name="email" style="direction: rtl;" placeholder="البريد الإلكتروني"
                            required class="form-control mb-2">
                        <textarea name="message" placeholder="رسالتك" required class="form-control mb-2"
                            style="    height: 208px;resize: none;"></textarea>
            ...
            <div class="text-center mt-5">
                ...
                <div class="d-flex justify-content-center gap-4 fs-4">
                    <a href="https://www.facebook.com/profile.php?id=100088795863299" target="_blank"
                        class="text-primary"><i class="fab fa-facebook-f"></i></a>
                    <a href="https://www.instagram.com/bookaboo.store/" target="_blank" class="text-danger"><i
                            class="fab fa-instagram"></i></a>
                    <a href="https://api.whatsapp.com/send/?phone=201234567890&text&type=phone_number&app_absent=0"
